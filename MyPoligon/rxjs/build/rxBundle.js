...
var _initData = __webpack_require__(9);

window.initData = new _initData.initData();
...
var _BehaviorSubject = __webpack_require__(10);
...
var initData = exports.initData = function () {
    function initData() {
        ...
        this._name = new _BehaviorSubject.BehaviorSubject('');
        this._age = new _BehaviorSubject.BehaviorSubject(null);
        this._company = new _BehaviorSubject.BehaviorSubject('');
        this._email = new _BehaviorSubject.BehaviorSubject('');
